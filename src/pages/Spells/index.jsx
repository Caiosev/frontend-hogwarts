...
export default function Spells() {
    return (
        <>
            ...
            <S.Container>
                <h1>Feitiços</h1>
                <h3>Estude aqui os feitiços para a prova</h3>
                <p>Passe mouse ou pressione sobre um feitiço</p>
                <main>
                        ...
                        <div className="spell-card__inner">
                            <div className="spell-card__shape">
                                <div
                                    ...
                                    style={{
                                        backgroundImage: `url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/accio.svg')`,
                                    }}
                                />
                                <svg
                                ...
                                >
                                    <clipPath id="clip-accio">
                                        <path d="M125,89c43.91,0,80.83,27.11,91.58,63.89C210.25,111.13,171.66,79,125,79s-85.25,32.13-91.58,73.89C44.17,116.11,81.09,89,125,89Z" />
                                    </clipPath>
                                    <path
                            ...
                            <div className="spell-card__name">
                                <h5>Accio</h5>
                                <p>
                                    Chama itens que estão em uma longa distância
                                    para as mãos do bruxo
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="spell-card__inner">
                            <div className="spell-card__shape">
                                <div
                                    ...
                                    style={{
                                        backgroundImage: `url(
                                        'https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/aguamenti.svg'
                                    )`,
                                    }}
                                />
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 201 117.05"
                                >
                        ...
                        <div className="spell-card__inner">
                            <div className="spell-card__shape">
                                <div
                                    ...
                                    style={{
                                        backgroundImage: `url(
                                        'https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/arresto.svg'
                                    )`,
                                    }}
                                />
                            ...
                            <div className="spell-card__name">
                                ...
                                <p>Diminui a velocidade de um objeto.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="spell-card__inner">
                            <div className="spell-card__shape">
                                <div
                                    ...
                                    style={{
                                        backgroundImage: `url(
                                        'https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/meteo.svg'
                                    )`,
                                    }}
                                />
                            ...
                            <div className="spell-card__name">
                                ...
                                <p>
                                    Encantamento para um contra-feitiço que
                                    causa efeitos do clima
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="spell-card__inner">
                            <div className="spell-card__shape">
                                <div
                                    ...
                                    style={{
                                        backgroundImage: `url(
                                        'https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/expecto.svg'
                                    )`,
                                    }}
                                />
                            ...
                            <div className="spell-card__name">
                                ...
                                <p>
                                    A única defesa conhecida contra Dementadores
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="spell-card__inner">
                            <div className="spell-card__shape">
                                <div
                                    ...
                                    style={{
                                        backgroundImage: `url(
                                        'https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/ridi.svg'
                                    )`,
                                    }}
                                />
                                <svg
                            ...
                            <div className="spell-card__name">
                                <h5>Riddikkulus</h5>
                                <p>
                                    Força um bicho-papão a ter a aparência de um
                                    objeto no qual o conjurador está pensando
                                </p>
                            </div>
                        </div>
                    </div>
